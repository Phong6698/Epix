...
public class Level1State extends GameState {
	...
	private void spawnPowerups() {
		 ...
		 */
		DamageUp damageUp;
		Point[] damagUpPoints = new Point[] { new Point(560, 144),
	...
	private void spawnEnemies() {
		...
		Plant s;
		Point[] plantPoints = new Point[] { new Point(460, 70), new Point(2315, 70) };
		...
		Magician m;
		Point[] magicanPoints = new Point[] { new Point(3150, 240) };
	...
	public boolean OnScreen(Player player, Player player_2) {

		if (player.getx() - 48 < player_2.getx() && player.getx() + 32 - player_2.getx() > 0) {
			return true;
		} else {
			return false;
		}
